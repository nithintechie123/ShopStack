...
const STATUS_META = {
  ...
  READY_TO_SHIP:       { label: 'Ready for Shipment', cls: 'bg-green-500/10 border-green-500/20 text-green-400' },
  ...
  DISPATCHED:          { label: 'Dispatched',          cls: 'bg-accent-warning/10 border-accent-warning/20 text-accent-warning' },
  IN_TRANSIT:          { label: 'In Transit',         cls: 'bg-indigo-500/10 border-indigo-500/20 text-indigo-400' },
